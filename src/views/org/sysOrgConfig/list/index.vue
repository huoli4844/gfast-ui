  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">    
      ...
      <el-form-item label="系统类型" prop="appId">
        <el-select v-model="queryParams.appId" placeholder="请选择系统类型" clearable size="small">
            <el-option
    ...
    <el-table v-loading="loading" :data="sysOrgConfigList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />      
      <el-table-column label="组织机构" align="center" prop="deptId" />     
      <el-table-column label="系统类型" align="center" prop="appId" :formatter="appIdFormat" />      
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body :close-on-click-modal="false">
      ...
      <el-form-item label="组织机构id 就是部门ID" prop="deptId">
           <el-input v-model="form.deptId" placeholder="请输入组织机构id 就是部门ID" />
      </el-form-item>      
      ...
      <el-form-item label="系统内置（Y是 N否）" prop="configType">
          <el-select v-model="form.configType" placeholder="请选择系统内置（Y是 N否）">
...
export default {
  ...
  methods: {    
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除公司参数管理编号为"' + ids + '"的数据项?', "警告", {
